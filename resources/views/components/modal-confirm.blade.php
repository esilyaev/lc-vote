<div x-data="{ isOpen: false, messageToDisplay: '' }">
    ...
    <div x-cloak x-transition.duration.300ms x-show="isOpen" @keydown.escape.window="isOpen = false" x-init="window.livewire.on('ideaWasUpdated', (message) => { isOpen = true; messageToDisplay = message; setTimeout(() => { isOpen = false}, 5000) })" class="fixed bottom-0 right-0 z-10 flex justify-between w-full max-w-sm px-6 py-6 mx-6 my-8 bg-white border shadow-lg rounded-xl">
