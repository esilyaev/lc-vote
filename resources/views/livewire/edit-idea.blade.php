...
<div x-init="$wire.on('ideaWasUpdated',() => isOpen = false)" x-cloak @custom-show-edit-modal.window="isOpen = true" x-data="{ isOpen: false }" x-show="isOpen" @keydown.escape.window="isOpen = false" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <!--
  ...
  -->
    ...
    <div class="fixed z-10 inset-0 overflow-y-auto">
        <div class="flex items-end justify-center min-h-screen">
            ...
            <div x-show="isOpen" x-transition.origin.bottom.duration.300ms class="modal relative  bg-white rounded-t-xl text-left overflow-hidden shadow-xl transform transition-all sm:align-middle sm:max-w-lg sm:w-full pt-4">
                <div class="absolute top-0 right-0 pt-4 pr-4 ">
                    <button @click="isOpen = false" class="text-gray-400 hover:text-gray-900 text-lg h-6 w-6">
                    ...
                    <div class="sm:flex sm:items-start">
                        <form wire:submit.prevent="editIdea" action="#" method="post" class="space-y-4 px-4 pt-6 w-full">
                            ...
                            <div class="flex items-center justify-between space-x-3">
                                <button class="flex items-center justify-center bg-gray-100 rounded-xl border border-gray-100 px-6 py-3 w-1/2 h-11 font-semibold
              hover:border-gray-400 transition duration-150 ease-in">
                                ...
                                <button class="flex items-center justify-center text-white bg-blue-500 rounded-xl border border-blue-500 px-6 py-3 w-1/2 h-11 font-semibold
